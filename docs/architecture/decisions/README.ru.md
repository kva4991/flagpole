...
- [ADR-0030: Git LFS и единый сборочный интерфейс](0030-git-lfs-and-unified-build.ru.md)
- [ADR-0031: раздельные лицензии аппаратуры и ПО](0031-split-hardware-and-software-licensing.ru.md)
- [ADR-0032: один медиа-ID — один подробный rationale-файл](0032-one-media-id-one-rationale-file.ru.md)
- [ADR-0033: компактный критический контракт в каждом медиа-описании](0033-compact-critical-contract-per-media.ru.md)
- [ADR-0034: единый реестр физических размеров компонентов](0034-single-physical-component-measurement-registry.ru.md)
- [ADR-0035: жёсткая PETG-втулка 6806 и независимые посадочные пробники](0035-rigid-petg-6806-adapter-and-independent-fit-coupons.ru.md)
- [ADR-0036: закрытая гибкая разгрузка кабеля в нижнем торце секции](0036-lower-pole-flexible-cable-strain-relief.ru.md)
- [ADR-0037: не хранить устаревшие бинарные генерации в текущем дереве](0037-prune-superseded-generated-binaries.ru.md)
