...
namespace cfg {
// Имя вашего проекта и имя BLE редактируются только в project_identity.json.
inline constexpr const char* PROJECT_DISPLAY_NAME = project_identity::PROJECT_DISPLAY_NAME;
inline constexpr const char* DEVICE_NAME = project_identity::BLE_DEVICE_NAME;
...
inline constexpr uint32_t BLE_IDLE_WINDOW_MS = 60UL * 60UL * 1000UL; // 1 час
...
inline constexpr float MIN_CALIBRATION_GAP_LUX = 5.0f;
