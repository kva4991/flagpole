...
& "$env:FLAGPOLE_EXECUTION_ROOT\.mechanical-venv\Scripts\python.exe" mechanical\generate_detail_diagrams_v074.py
& "$env:FLAGPOLE_EXECUTION_ROOT\.mechanical-venv\Scripts\python.exe" mechanical\generate_hermeticity_diagram_v074.py
& "$env:FLAGPOLE_EXECUTION_ROOT\.mechanical-venv\Scripts\python.exe" electronics\generate_electronics_diagrams_v074.py
